 ...
 */
@Component
public class CatSlf4jLogModule extends AbstractPluginModuleDefinitionProcessor {
    ...
    public String pluginName() {
        return "cat-slf4j-log-plugin";
    }

    @Override
    public List<EnhanceClassInfo> getEnhanceClassInfos() {
        EnhanceClassInfo log = EnhanceClassInfo.builder().classPattern("org.slf4j.Logger").methodPatterns(EnhanceClassInfo.MethodPattern.transform("info", "debug", "warn", "error")).includeSubClasses(true).build();
