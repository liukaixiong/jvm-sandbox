...
public class MonitorProcess extends AbstractCommandInvoke {
    ...
    private Long invokeSecond = 120L;

    private Long startTime;

    private Map<Integer, MonitorResult> monitorResultMap;
    ...
    public MonitorProcess(CommandWatcherInfoModel commandObject) {
        super(commandObject);
        this.invokeSecond = ObjectUtils.defaultIfNull(commandObject.getTimeOut(), this.invokeSecond);
        this.startTime = System.currentTimeMillis();
        this.monitorResultMap = initMonitorResultCache(this.invokeSecond);
    }
